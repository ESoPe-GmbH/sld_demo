...
/// Enable the display driver for SLD displays
#define DISPLAY_ENABLE_SLD							true
#endif
...
#define ESO_FILE_ENABLE_MMC							false
...
/// Enable initialization of DM9051 phy for ESP32
#define PHY_ENABLE_ESP_DM9051						false
...
/// If enabled, the @c network_init call inside the main in @c sys.c will be skipped. If disabled, the network is initialized normally before calling @c app_main_init
#define NETWORK_SKIP_INIT_IN_SYS					true
#endif
...
/// Maximum allowed update tries per hour. If set to 0 no restrictions apply
#define REDEBUS_UPDATE_TRIES_PER_HOUR      0
/// If no packets are received at all during this period, the connection is considered faulted
#define REDEBUS_NO_RECEIVE_TIMEOUT			60000
/// If no packets addressed to this peripheral are received during this period, the connection is considered faulted
#define REDEBUS_NO_OWN_RECEIVE_TIMEOUT		600000
/// If no packets addressed to this peripheral are received during this period, the connection is considered faulted
#define REDEBUS_REQUIRED_PERIPHERAL_TIMEOUT	600000
/// Define for the timeout in the `redebus_l3_transport_read_pt` function. This is used for frames that trigger certain actions like flash writing / erasure that might take longer.
#define REDEBUS_L3_TIMEOUT_DEFAULT_LONG         10000
#endif
...
// rtc
//------------------------------------
/// Set to true if rv3028 is used over i2c connection. Make sure to call rtc_rv3028_init if it is used.
#define RTC_ENABLE_RV3028   			            true
/// Set to true if 3032 is used over i2c connection. Make sure to call rtc_rv3032_init if it is used.
#define RTC_ENABLE_RV3032   			            false
...
#define SW_UPDATE_ENABLE_V3			                false			
...
/// If true the public flag is required to be present in the eso
#define SW_UPDATE_IS_PUBLIC_REQUIRED				false		
#endif
