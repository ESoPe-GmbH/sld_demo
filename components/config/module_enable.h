...
#define MODULE_ENABLE_DISPLAY                           1

/// Enables DOG OLED driver in gui.
#define MODULE_ENABLE_DISPLAY_DOG_OLED                  0
...
#define MODULE_ENABLE_FLASH_EMULATION                   0
...
#if defined(WIFI_DEMO)
/// Enables the module for network interfaces
#define MODULE_ENABLE_NETWORK							1
#else
/// Enables the module for network interfaces
...
/// Enables the registry module used to organize data for serialization
#define MODULE_ENABLE_REGISTRY                          1
...
/// Enables the magnet sensor MLX90393
#define MODULE_ENABLE_SENSOR_MAGNET_MLX90393            0
...
/// Enable the module for the DS1631Z temperature sensor
#define MODULE_ENABLE_SENSOR_TEMPERATURE_DS1631         0

/// Enables the module for an TMP102 temperature sensor
#define MODULE_ENABLE_SENSOR_TEMPERATURE_TMP102			0

/// Enables the module for the MLX90614 infrared temperature sensor
#define MODULE_ENABLE_SENSOR_TEMPERATURE_MLX90614       0

/// Enables the module for the MLX90632 infrared temperature sensor
#define MODULE_ENABLE_SENSOR_TEMPERATURE_MLX90632       0

/// Enables the module for the MLX90640 infrared temperature sensor
#define MODULE_ENABLE_SENSOR_TEMPERATURE_MLX90640       0
...
#define MODULE_ENABLE_SERIALPROTOCOL_REDEBUS            1
...
#define MODULE_ENABLE_LCD_TOUCH                         1
...
#define MODULE_ENABLE_LCD_TOUCH_DRIVER_ST1633I          1
